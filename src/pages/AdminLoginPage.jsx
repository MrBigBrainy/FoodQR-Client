            ...
            >
                ...
                <div className="bg-white/95 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/20">
                    ...
                    <div className="relative flex p-1.5 bg-gray-100/80 rounded-xl mb-8 shadow-inner">
                        <div
                            className={`absolute top-1.5 bottom-1.5 w-[calc(50%-6px)] bg-white rounded-lg shadow-sm transition-all duration-300 ease-out ${activeTab === 'login' ? 'left-1.5' : 'left-[calc(50%+3px)]'
                                }`}
                        />
                        <button
                            onClick={() => setActiveTab('login')}
                            className={`relative z-10 w-1/2 py-2.5 text-sm font-semibold transition-colors duration-300 ${activeTab === 'login' ? 'text-red-600' : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                            เข้าสู่ระบบ
                        </button>
                        <button
                            ...
                            className={`relative z-10 w-1/2 py-2.5 text-sm font-semibold transition-colors duration-300 ${activeTab === 'register' ? 'text-red-600' : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                            สมัครสมาชิก
                        </button>
