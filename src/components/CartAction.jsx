      ...
      <div className="flex space-x-4">
        <div className="flex justify-between w-full space-x-4">
          <button 
            ...
            className={`${staffCalled ? 'bg-[#C10007] text-white' : 'bg-white text-[#C10007]'} flex gap-2 justify-center items-center font-medium py-2 px-3 rounded-lg shadow-md transition-colors w-full cursor-pointer`}
          >
